...
type Session struct {
	...
	AllowRevocation bool `yaml:"allow_revocation" json:"allow_revocation" koanf:"allow_revocation" jsonschema:"default=true"`
	...
	AcquireIPAddress bool `yaml:"acquire_ip_address" json:"acquire_ip_address" koanf:"acquire_ip_address" jsonschema:"default=true"`
	// `acquire_user_agent` stores the user's user agent in the database.
	AcquireUserAgent bool `yaml:"acquire_user_agent" json:"acquire_user_agent" koanf:"acquire_user_agent" jsonschema:"default=true"`
	...
	EnableAuthTokenHeader bool `yaml:"enable_auth_token_header" json:"enable_auth_token_header" koanf:"enable_auth_token_header" split_words:"true" jsonschema:"default=false"`
	...
	Lifespan string `yaml:"lifespan" json:"lifespan" koanf:"lifespan" jsonschema:"default=12h"`
	...
	// numbers, each with optional fraction and a unit suffix, such as "300ms", "-1.5h" or "2h45m".
	// Valid time units are "ns", "us" (or "µs"), "ms", "s", "m", "h".
	IdleTimeout string `yaml:"idle_timeout,omitempty" json:"idle_timeout" koanf:"idle_timeout" jsonschema:"default=0m" split_words:"true"`
}
...
type Cookie struct {
	...
	Name string `yaml:"name" json:"name" koanf:"name" jsonschema:"default=hanko"`
	// `retention` determines the retention behavior of authentication cookies.
	Retention string `yaml:"retention" json:"retention" koanf:"retention" split_words:"true" jsonschema:"default=persistent,enum=session,enum=persistent,enum=prompt"`
	...
	// more details.
	SameSite string `yaml:"same_site" json:"same_site," koanf:"same_site" split_words:"true" jsonschema:"default=strict,enum=strict,enum=lax,enum=none"`
	...
	Secure bool `yaml:"secure" json:"secure" koanf:"secure" jsonschema:"default=true"`
}
...
type JWTTemplate struct {
	Claims map[string]interface{} `yaml:"claims" json:"claims" koanf:"claims"`
}
