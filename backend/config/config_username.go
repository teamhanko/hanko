...
type Username struct {
	...
	MaxLength int `yaml:"max_length" json:"max_length" koanf:"max_length" jsonschema:"default=32"`
	// `min_length` specifies the minimum length of a username.
	MinLength int `yaml:"min_length" json:"min_length" koanf:"min_length" split_words:"true" jsonschema:"default=3"`
