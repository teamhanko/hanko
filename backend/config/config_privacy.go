...
type Privacy struct {
	...
	ShowAccountExistenceHints bool `yaml:"show_account_existence_hints" json:"show_account_existence_hints" koanf:"show_account_existence_hints" split_words:"true" jsonschema:"default=false"`
	...
	OnlyShowActualLoginMethods bool `yaml:"only_show_actual_login_methods" json:"only_show_actual_login_methods" koanf:"only_show_actual_login_methods" split_words:"true" jsonschema:"default=false"`
}
