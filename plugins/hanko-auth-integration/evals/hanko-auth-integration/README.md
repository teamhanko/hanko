...
These eval cases check the behavior of the `hanko-auth-integration` agent plugin, not Hanko itself. They are meant to verify that the plugin produces useful plans, safe boundaries, and concrete acceptance checks for common Hanko workflows.
