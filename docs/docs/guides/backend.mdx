...
_If you are using the [NuxtJS framework](/guides/nuxt 'NuxtJS'), please check the [frontend guide](/guides/nuxt) on how to authenticate requests on the backend._
