...
<TabItem value="python" label="Python">
 ```
This is an example of how you could implement JWT verification in a Python-based backend using
 the [python-jose](https://pypi.org/project/python-jose/)-library.  
...
# Replace with your Hanko API URL
HANKO_API_URL = "https://your-hanko-api-url.com"

# Fetch JWK Set from Hanko API's .well-known/jwks.json endpoint
jwks_response = requests.get(f"{HANKO_API_URL}/.well-known/jwks.json")
jwks_data = jwks_response.json()

# Create a JWK keyset instance from the retrieved data
jwk_set = jwk.JWKSet.from_dict(jwks_data)
