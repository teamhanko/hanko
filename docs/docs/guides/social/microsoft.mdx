...
The above command will create two files in the current directory, `key.pem` and `cert.pem`. You need to upload `cert.pem`, which represents the public key, to Azure.
